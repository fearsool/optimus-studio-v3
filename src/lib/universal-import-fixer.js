...
exports.UniversalImportFixer = void 0;
...
class UniversalImportFixer {
    static fixFile(filePath) {
        ...
        if (changesMade) {
            ...
            // Write fixed content
            (0, fs_1.writeFileSync)(filePath, fixedContent, 'utf-8');
            console.log(`✅ Fixed imports in: ${filePath}`);
            return true;
        }
        return false;
    }
    static hasDefaultExportIssue(moduleName) {
        ...
        return problematicModules.some(m => moduleName === m || moduleName.startsWith(m + '/'));
    }
    static fixProject(rootDir) {
...
exports.UniversalImportFixer = UniversalImportFixer;
UniversalImportFixer.MODULE_MAP = {
