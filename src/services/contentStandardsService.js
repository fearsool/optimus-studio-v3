...
exports.generateAnswersFromTemplate = exports.VIDEO_STANDARDS = exports.CONTENT_TEMPLATES = exports.runFullContentAnalysis = exports.calculateSemanticScore = exports.identifyAmygdalaTriggers = exports.analyzePsychographics = exports.analyzeGaps = exports.SCORE_THRESHOLDS = exports.STEP_QUESTIONS = void 0;
// ============================================
// 4 ADIM SORU SETİ
// Her adım için kullanıcıdan alınacak bilgiler
// ============================================
exports.STEP_QUESTIONS = {
...
async function generateAIJSON(prompt, fallback) {
    ...
    // 2. Try Groq (Llama 3)
    try {
        const groqResult = await groqService_1.groqService.generateJSON('You are a helpful JSON generator. Output strictly valid JSON.', prompt);
        if (groqResult) {
...
// ============================================
async function analyzeGaps(brief) {
    const prompt = `
...
// ============================================
async function analyzePsychographics(brief) {
    const prompt = `
...
exports.analyzePsychographics = analyzePsychographics;
// ============================================
// ADIM 3: AMİGDALA DÜRTÜLEME
// Duygusal tetikleyicileri belirle
// ============================================
async function identifyAmygdalaTriggers(brief, psychographics) {
    const prompt = `
...
exports.identifyAmygdalaTriggers = identifyAmygdalaTriggers;
// ============================================
// ADIM 4: SEMANTİK PUANLAMA
// İçerik kalitesini ölç ve skorla
// ============================================
async function calculateSemanticScore(content, brief) {
    ...
    const overallScore = Math.round((readabilityScore * 0.15) +
    ...
    if (readabilityScore < 70)
        suggestions.push('Cümleleri kısalt');
    if (emotionalImpact < 50)
        suggestions.push('Daha duygusal kelimeler ekle');
    if (clarityScore < 60)
        suggestions.push('Rakamlar ve maddeler kullan');
    if (actionabilityScore < 50)
        suggestions.push('Net bir CTA ekle');
    if (viralPotential < 50)
        suggestions.push('Merak uyandıran hook ekle');
    return {
        readabilityScore,
        emotionalImpact,
        clarityScore,
...
exports.calculateSemanticScore = calculateSemanticScore;
// ============================================
// ANA FONKSİYON: TAM ANALİZ
// 4 adımı birleştir
// ============================================
async function runFullContentAnalysis(brief, draftContent) {
    ...
    const finalScore = Math.round((gapAnalysis.score * 0.20) +
...
exports.runFullContentAnalysis = runFullContentAnalysis;
// ============================================
// İÇERİK ŞABLONLARI
 ...
 */
async function generateAnswersFromTemplate(template) {
...
exports.generateAnswersFromTemplate = generateAnswersFromTemplate;
// ============================================
// EXPORT
// ============================================
exports.default = {
    ...
    CONTENT_TEMPLATES: exports.CONTENT_TEMPLATES,
    VIDEO_STANDARDS: exports.VIDEO_STANDARDS
};
