...
exports.CodeGeneratorHF = exports.generateCode = exports.generateGitHubAction = exports.generateNodeJsScript = exports.generatePythonScript = void 0;
...
// ==================== NODE.JS GENERATOR ====================
const generateNodeJsScript = (blueprint) => {
...
exports.generateNodeJsScript = generateNodeJsScript;
...
// ==================== EXPORT FUNCTION ====================
const generateCode = (blueprint, format) => {
    switch (format) {
        case 'python':
            return (0, exports.generatePythonScript)(blueprint);
        case 'nodejs':
            return (0, exports.generateNodeJsScript)(blueprint);
        case 'github-action':
            return (0, exports.generateGitHubAction)(blueprint);
        default:
            return (0, exports.generatePythonScript)(blueprint);
    }
};
...
// ==================== CLASS WRAPPER ====================
class CodeGeneratorHF {
    generateCode(blueprint, format) {
        return (0, exports.generateCode)(blueprint, format);
    }
    generatePythonScript(blueprint) {
        return (0, exports.generatePythonScript)(blueprint);
    }
    generateNodeJsScript(blueprint) {
        return (0, exports.generateNodeJsScript)(blueprint);
    }
    generateGitHubAction(blueprint) {
        return (0, exports.generateGitHubAction)(blueprint);
    }
    ...
    async generatePracticeExercise(params) {
        return {
            code: `// Practice Exercise\n// ${params.prompt}\n\nfunction practice() {\n  console.log("Practice makes perfect");\n}`
        };
    }
}
exports.CodeGeneratorHF = CodeGeneratorHF;
