...
exports.GITHUB_IMPORTED_TEMPLATES = void 0;
const types_1 = require("../../types");
// Helper to create template
const createTemplate = (id, name, description, category, icon, tags, estimatedRevenue) => ({
    id,
    name,
    description,
    category,
    ...
    blueprint: {
        ...
        nodes: [
            { id: `${id}-1`, type: types_1.NodeType.STATE_MANAGER, title: 'Başlangıç', role: 'Trigger', task: 'Workflow başlat', status: types_1.StepStatus.IDLE, connections: [{ targetId: `${id}-2` }] },
            { id: `${id}-2`, type: types_1.NodeType.EXTERNAL_CONNECTOR, title: 'Veri Al', role: 'API', task: 'Kaynak verilerini çek', status: types_1.StepStatus.IDLE, connections: [{ targetId: `${id}-3` }] },
            { id: `${id}-3`, type: types_1.NodeType.AGENT_PLANNER, title: 'İşle', role: 'Processor', task: 'Verileri dönüştür', status: types_1.StepStatus.IDLE, connections: [{ targetId: `${id}-4` }] },
            { id: `${id}-4`, type: types_1.NodeType.EXTERNAL_CONNECTOR, title: 'Gönder', role: 'Output', task: 'Sonucu hedef sisteme gönder', status: types_1.StepStatus.IDLE, connections: [] }
        ]
    }
});
exports.GITHUB_IMPORTED_TEMPLATES = [
...
exports.default = exports.GITHUB_IMPORTED_TEMPLATES;
