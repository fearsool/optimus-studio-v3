import { AutomationTemplate, RefineLevel, MonetizationType } from './store';
import { NodeType, StepStatus } from '../../types';

export const ETSY_SEO_LISTING_ENGINE: AutomationTemplate = {
    ...
    blueprint: {
        nodes: [
            ...
            {
                id: 'input-node',
                type: NodeType.EXTERNAL_CONNECTOR, // HUMAN_IN_THE_LOOP not available, using Connector or Approval
                title: 'Ürün Bilgisi',
                role: 'User',
            ...
            {
                id: 'ai-seo',
                type: NodeType.AGENT_PLANNER, // Replace AGENT
                title: 'AI SEO Uzmanı',
                role: 'GPT-4o',
            ...
            {
                id: 'ai-desc',
                type: NodeType.CONTENT_CREATOR, // Copywriter fits here
                title: 'Copywriter',
                role: 'Claude 3.5',
