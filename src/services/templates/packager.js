...
exports.templatePackager = exports.TemplatePackager = void 0;
/**
...
class TemplatePackager {
     ...
     */
    packageForExport(template, includeFeedback = true) {
        var _a, _b, _c, _d;
        const packageId = `${template.id}-v${((_a = template.blueprint) === null || _a === void 0 ? void 0 : _a.version) || 1}`;
        const files = {};
        ...
        files['automation.json'] = JSON.stringify({
            ...
            version: ((_b = template.blueprint) === null || _b === void 0 ? void 0 : _b.version) || 1,
            nodes: ((_c = template.blueprint) === null || _c === void 0 ? void 0 : _c.nodes) || [],
        ...
        return {
            id: packageId,
            name: template.name,
            version: `${((_d = template.blueprint) === null || _d === void 0 ? void 0 : _d.version) || 1}.0.0`,
            files,
            meta: {
     ...
     */
    createBundle(templates, bundleMeta) {
        const files = {};
        // Bundle README
...
Bu bundle ile tahmini kazanç: ${templates.reduce((sum, t) => {
            var _a;
            const match = (_a = t.estimatedRevenue) === null || _a === void 0 ? void 0 : _a.match(/(\d+)/);
...
`;
    ...
    generateReadme(template, feedbackEnabled) {
...
`;
    ...
    generateFeedbackClientJS(automationId) {
        return `/**
...
exports.TemplatePackager = TemplatePackager;
exports.templatePackager = new TemplatePackager();
