            ...
            for (const dir of pieceDirs) {
                ...
                const blueprint = {
                    nodes: [
                        ...
                        {
                            id: 'action-1',
                            type: NodeType.EXTERNAL_CONNECTOR, // External integration
                ...
                // Supabase'e ekle
                const newTemplate: Partial<AutomationTemplate> = {
                ...
                try {
                    ...
                    const existingIndex = existingTemplates.findIndex((t: any) => t.id === newTemplate.id);
