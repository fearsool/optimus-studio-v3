...
exports.canCustomize = exports.CUSTOMIZATION_RULES = exports.validateMessage = exports.LOCKED_MESSAGES = exports.SALON_PSYCHOLOGY_RULES = void 0;
// ============================================
// LOCKED PSYCHOLOGY RULES
// ============================================
exports.SALON_PSYCHOLOGY_RULES = Object.freeze({
    version: 'LOCKED_V1',
    immutable: true,
...
// ============================================
exports.LOCKED_MESSAGES = Object.freeze({
...
// ============================================
exports.CUSTOMIZATION_RULES = Object.freeze({
 ...
 */
const canCustomize = (field) => {
    if (exports.CUSTOMIZATION_RULES.forbidden.includes(field)) {
        console.error(`[SALON_STANDARDS] BLOCKED: Cannot customize "${field}" - LOCKED`);
        return false;
    }
    return exports.CUSTOMIZATION_RULES.allowed.includes(field);
};
exports.canCustomize = canCustomize;
