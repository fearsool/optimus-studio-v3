...
exports.generateConnectorCode = exports.API_CONNECTORS = exports.BINANCE_CONNECTOR = exports.SHEETS_CONNECTOR = exports.TELEGRAM_CONNECTOR = exports.EMAIL_CONNECTOR = exports.GEMINI_CONNECTOR = exports.HUGGINGFACE_CONNECTOR = void 0;
// HuggingFace AI Connector
exports.HUGGINGFACE_CONNECTOR = {
    name: 'HuggingFace',
    type: 'ai',
...
exports.API_CONNECTORS = {
    'huggingface': exports.HUGGINGFACE_CONNECTOR,
    'gemini': exports.GEMINI_CONNECTOR,
    'email': exports.EMAIL_CONNECTOR,
    'telegram': exports.TELEGRAM_CONNECTOR,
    'sheets': exports.SHEETS_CONNECTOR,
    'binance': exports.BINANCE_CONNECTOR
};
// Connector'a göre Python kodu üret
function generateConnectorCode(connectorNames) {
    const imports = new Set();
    const functions = [];
    connectorNames.forEach(name => {
        const connector = exports.API_CONNECTORS[name];
        if (connector) {
...
exports.generateConnectorCode = generateConnectorCode;
