...
exports.CodeGeneratorService = exports.generateWorkflow = exports.generateRequirements = exports.generatePythonFile = exports.PYTHON_TEMPLATES = void 0;
const apiConnectorService_1 = require("./apiConnectorService");
...
function generatePythonFile(templateId, env = {}) {
    const template = exports.PYTHON_TEMPLATES[templateId];
    if (!template) {
        throw new Error(`Template bulunamadı: ${templateId}`);
    }
    // Connector kodlarını al
    const connectorCode = (0, apiConnectorService_1.generateConnectorCode)(template.connectors);
    // Env dosyası içeriği
...
exports.generatePythonFile = generatePythonFile;
// Requirements.txt üret
function generateRequirements(connectors) {
    ...
    connectors.forEach(connector => {
        var _a;
        (_a = connectorRequirements[connector]) === null || _a === void 0 ? void 0 : _a.forEach(req => allRequirements.add(req));
    });
    return Array.from(allRequirements).join('\\n');
}
exports.generateRequirements = generateRequirements;
// GitHub Actions workflow üret
function generateWorkflow(name, schedule = "0 9 * * *") {
    return `name: ${name}
...
exports.CodeGeneratorService = {
    templates: exports.PYTHON_TEMPLATES,
    generatePythonFile,
