...
exports.searchIdeas = exports.searchIdeasByTag = exports.getBeginnerFriendlyIdeas = exports.getLowCompetitionIdeas = exports.getMostProfitableIdeas = exports.getRandomIdea = exports.getCategories = exports.getIdeasByCompetition = exports.getIdeasByDifficulty = exports.getIdeasByCategory = exports.AUTOMATION_IDEAS = void 0;
// ============================================
// POPÜLER OTOMASİYON FİKİRLERİ VERİTABANI
// ============================================
exports.AUTOMATION_IDEAS = [
    // ===== SOSYAL MEDYA =====
    {
...
const getIdeasByCategory = (category) => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.category === category);
};
exports.getIdeasByCategory = getIdeasByCategory;
// Zorluğa göre filtrele
const getIdeasByDifficulty = (difficulty) => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.difficulty === difficulty);
};
exports.getIdeasByDifficulty = getIdeasByDifficulty;
// Rekabet seviyesine göre filtrele
const getIdeasByCompetition = (level) => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.competitionLevel === level);
};
exports.getIdeasByCompetition = getIdeasByCompetition;
// Tüm kategorileri getir
const getCategories = () => {
    return [...new Set(exports.AUTOMATION_IDEAS.map(idea => idea.category))];
};
exports.getCategories = getCategories;
// Rastgele fikir öner
const getRandomIdea = () => {
    return exports.AUTOMATION_IDEAS[Math.floor(Math.random() * exports.AUTOMATION_IDEAS.length)];
};
exports.getRandomIdea = getRandomIdea;
// En kârlı fikirleri getir
const getMostProfitableIdeas = (limit = 5) => {
    return [...exports.AUTOMATION_IDEAS]
        .sort((a, b) => {
...
exports.getMostProfitableIdeas = getMostProfitableIdeas;
// Düşük rekabetli fikirleri getir
const getLowCompetitionIdeas = () => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.competitionLevel === 'low');
};
exports.getLowCompetitionIdeas = getLowCompetitionIdeas;
// Başlangıç için uygun fikirleri getir
const getBeginnerFriendlyIdeas = () => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.difficulty === 'easy');
};
exports.getBeginnerFriendlyIdeas = getBeginnerFriendlyIdeas;
// Tag'e göre ara
const searchIdeasByTag = (tag) => {
    return exports.AUTOMATION_IDEAS.filter(idea => idea.tags.some(t => t.toLowerCase().includes(tag.toLowerCase())));
};
exports.searchIdeasByTag = searchIdeasByTag;
// Anahtar kelimeye göre ara
const searchIdeas = (query) => {
    const lower = query.toLowerCase();
    return exports.AUTOMATION_IDEAS.filter(idea => idea.title.toLowerCase().includes(lower) ||
        idea.description.toLowerCase().includes(lower) ||
        idea.tags.some(t => t.toLowerCase().includes(lower)));
};
exports.searchIdeas = searchIdeas;
exports.default = {
    AUTOMATION_IDEAS: exports.AUTOMATION_IDEAS,
    getIdeasByCategory: exports.getIdeasByCategory,
    getIdeasByDifficulty: exports.getIdeasByDifficulty,
    getIdeasByCompetition: exports.getIdeasByCompetition,
    getCategories: exports.getCategories,
    getRandomIdea: exports.getRandomIdea,
    getMostProfitableIdeas: exports.getMostProfitableIdeas,
    getLowCompetitionIdeas: exports.getLowCompetitionIdeas,
    getBeginnerFriendlyIdeas: exports.getBeginnerFriendlyIdeas,
    searchIdeasByTag: exports.searchIdeasByTag,
    searchIdeas: exports.searchIdeas
};
