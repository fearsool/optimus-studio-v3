...
const OptimusStudioMasterOS_1 = require("../src/core/OptimusStudioMasterOS");
async function runCompleteWorkflow() {
    console.log('🚀 OPTIMUS STUDIO - TAM OTONOM ÇALIŞTIRMA');
    const studio = new OptimusStudioMasterOS_1.OptimusStudioMasterOS();
    ...
    const automationResults = await studio.productionLines.automation.scoutAndPackage({
